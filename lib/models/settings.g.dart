...
void _settingsSerialize(
  ...
  writer.writeLong(offsets[1], object.language);
  writer.writeBool(offsets[2], object.notification);
}
...
Settings _settingsDeserialize(
  ...
  object.id = id;
  object.language = reader.readLong(offsets[1]);
  object.notification = reader.readBool(offsets[2]);
  return object;
}
...
extension SettingsQueryFilter
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition> notificationEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension SettingsQuerySortBy on QueryBuilder<Settings, Settings, QSortBy> {
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> sortByNotification() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notification', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> sortByNotificationDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingsQuerySortThenBy
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> thenByNotification() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notification', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> thenByNotificationDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notification', Sort.desc);
    });
  }
...
extension SettingsQueryWhereDistinct
  ...
  QueryBuilder<Settings, Settings, QDistinct> distinctByNotification() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingsQueryProperty
  ...
  QueryBuilder<Settings, bool, QQueryOperations> notificationProperty() {
    return QueryBuilder.apply(this, (query) {
